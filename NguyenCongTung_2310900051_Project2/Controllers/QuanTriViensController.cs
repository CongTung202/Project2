...
namespace NguyenCongTung_2310900051_Project2.Controllers
{
    public class QuanTriViensController : Controller
    {
        ...
        public QuanTriViensController(CuahangTapHoaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TaiKhoan,MatKhau")] QuanTriVien quanTriVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TaiKhoan,MatKhau")] QuanTriVien quanTriVien)
        {
