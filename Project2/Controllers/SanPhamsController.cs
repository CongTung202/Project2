...
namespace Project2.Controllers
{
    public class SanPhamsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaSp,TenSp,MoTa,DonGia,SoLuong,HinhAnh,MaLoai,TrangThai")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaSp,TenSp,MoTa,DonGia,SoLuong,HinhAnh,MaLoai,TrangThai")] SanPham sanPham)
        {
            if (id != sanPham.MaSp)
            {
                return NotFound();
